...
import type { ScheduleRuleDto, TaskEntryDto } from "@/api";
import type { ScheduleRule } from "@/models";
import type { NaggerNode, NagPlanNode, TaskItemNode, TaskLogNode } from "@/models/clientModel";
import type {
  ClientModel,
  ClientNodeType,
...
export type NagPlanTraversedNode = Immutable<
  NagPlanNode<NaggerTraversedNode> & PartialClientModelExtension<NagPlanClientModelExtension>
>;

export type NaggerTraversedNode = Immutable<
  NaggerNode<TaskLogTraversedNode, ScheduleRuleDto | ScheduleRule> &
